...
export const CONTENT: Record<string, Translation> = {
  vn: {
    ...
    about: {
      ...
      missionDesc: "Phổ cập công nghệ cao, đặc biệt là AI và Automation, giúp doanh nghiệp Việt Nam và quốc tế tối ưu vận hành và bứt phá doanh thu.",
      visionTitle: "Tầm Nhìn 2030",
      visionDesc: "Trở thành Top 10 đơn vị cung cấp giải pháp Value-Added Services và AI ứng dụng tại Đông Nam Á.",
  ...
  en: {
    ...
    about: {
      ...
      missionDesc: "Democratizing high-tech, especially AI and Automation, to help businesses in Vietnam and globally optimize operations and boost revenue.",
      visionTitle: "Vision 2030",
      visionDesc: "To become a Top 10 provider of Value-Added Services and Applied AI solutions in Southeast Asia.",
